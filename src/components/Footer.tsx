...
const Footer = () => {
  return (
    <footer className="bg-black/30 border-t border-border">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Channel List</a></li>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <img src="https://www.visa.com/images/processing/visa-logo.svg" alt="Visa" className="h-6" />
          </div>
        </div>
      </div>
    </footer>
